...
ttk.Label(mainframe, text="Enter path to copy music files from: ").grid(column=0, row=1)
...
ttk.Label(mainframe, text="Enter path to copy music files to: ").grid(column=0, row=2)
...
ttk.Button(mainframe, text="Copy music files", command=gui_find_all_mp3_files).grid(column=1, row=5, sticky=W)
